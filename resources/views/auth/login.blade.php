...
<head>
    ...
    <link rel="icon" href="backend/images/hu.png">
                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="content-top-agile p-10">
                            <h2 class="text-white">Haramaya University Management</h2>
                        ...
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            ...
                            <div class="text-center">
                                ...
                                <p class="mt-15 mb-0 text-white">Are you student? <a href="{{ url('/studentdashboard') }}" class="text-info ml-5">click here</a></p>
                            </div>
                        </div>
                    </div>
                </div>
